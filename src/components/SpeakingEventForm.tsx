...
interface SpeakingEventFormProps {
  formContent: SpeakingFormContent;
...
export default function SpeakingEventForm({
  formContent,
  onSubmit,
  isSubmitting,
  errorMessage,
  onBack,
}: SpeakingEventFormProps) {
    ...
    >
      ...
      <div className="mb-8">
        <label className="block text-lg font-semibold mb-4 text-white">
          Event Type <span className="text-accent-300 ml-1">*</span>
        </label>

...
export default function RegistrationSection() {
  ...
  if (isSubmitted) {
    return (
      <section className="py-20 bg-gradient-to-br from-accent-600 via-accent-500 to-accent-400 text-white relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="fade-in bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
            ...
            <div className="bg-white/20 rounded-xl p-6 text-lg font-semibold">
